...
\033[1;91m        %%%%%%%%%%%%%%    %%%%%%%%%%%%%%  \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : idunil1
\033[1;93m(!)\033[1;97m Github   : https://github.com/idunil1
\033[1;93m(!)\033[1;97m Fb Profile   : https://www.facebook.com/Idunil.Sampath2003
\033[1;93m(!)\033[1;97m Whatsapp : 0716403298
\033[1;97m--------------------------------------------------
"""
...
def user_info():
    ...
    time.sleep(1)
    try:
        idunil = open("/sdcard/.idunil.txt", "r").read()
...
def choice_select():
	...
	print(50*"-")
	print("[!] The process has completed")
	print("[!] Total Idunil OK/Idunil CP :"+str(len(oks)))+"/"+str(len(cps))
	raw_input("[!] Press enter to back")
	choose()
